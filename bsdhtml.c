       ...
       else
       {
           ...
           if ( c == '\n' ) 
           {
             ...
             if ( area_archive == 0 )
             {
              if ( export_skip == 0 )
              {
                  ...
                  &&  ( lline[ 3 ] == ' ' ) )
               {
                 ...
                 fputs( "<li>" , target);
                 fputs( strcut( lline, 3 +2 , strlen( lline )) , target);
                 fputs( "</li>" , target);
                 fputs( "\n" , target);
               }
             ...
             ///////////
                ...
                ( ( lline[0] == '#' ) && ( strstr(lline, "#input{" ) != 0 ) )
             || ( ( lline[0] == '!' ) && ( strstr(lline, "!input{" ) != 0 ) )
                      )
             {
               strncpy( ncpfile , strcut( lline , 6+2 , strlen( lline )-1 )  ,  PATH_MAX );
               printf( "=> Found an include with string  |%s|%d|\n" , ncpfile , fexist( ncpfile ) );
               strncpy( ncpfile , "", PATH_MAX );
               strncat( ncpfile , strcut( lline , 6+2 , strlen( lline )-1 )  , PATH_MAX - strlen( ncpfile ) -1 );
             ...
             ///////////
                ...
                ( ( lline[0] == '#' ) && ( strstr(lline, "#include{" ) != 0 ) )
             || ( ( lline[0] == '!' ) && ( strstr(lline, "!include{" ) != 0 ) )
                      )
             {
